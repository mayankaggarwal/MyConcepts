...
public class NVPAPICaller
{
    ...
    public string APIUsername = "mayankaggarwal1989-facilitator_api1.gmail.com";
    private string APIPassword = "7ALLXGTSA4K3TPJ2";
    private string APISignature = "AvMyCQOG4U2K5OxEVZ.Nw1-I3-EEAwFXO3J7c9qrLTdk3CejOyQeFDkd";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:61167/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:61167/Checkout/CheckoutCancel.aspx";
